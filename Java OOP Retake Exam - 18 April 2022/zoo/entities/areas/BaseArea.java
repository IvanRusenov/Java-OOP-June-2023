...
public abstract class BaseArea implements Area {
    ...
    public String getInfo() {
        ...
        if (getAnimals().isEmpty()){
            ...
            sb.append(String.format("Animals: %s", getAnimals().stream().map(Animal::getName).collect(Collectors.joining(" ")))).append(System.lineSeparator());
        }
